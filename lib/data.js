...
export const navRoutes = [
  ...
  { labelKey: 'nav.stats', path: '/stats', icon: '\u2261' }
];

export const playlistData = [
  {
    title: 'Daily Mix 01',
    subtitle: 'Nova Bloom, Aster Lane, Mila Woods',
    description: 'Pop suave, bajos limpios y melodias nocturnas.',
    accent: 'lofi',
    mood: 'Night drive'
  },
  {
    title: 'Radar semanal',
    subtitle: 'Kite Club, Sora Vale y mas',
    description: 'Nuevos lanzamientos elegidos para ti.',
    accent: 'sunset',
    mood: 'Focus'
  },
  {
    title: 'Deep Focus',
    subtitle: 'Beats para concentrarte',
    description: 'Texturas tranquilas para entrar en zona.',
    accent: 'violet',
    mood: 'Study'
  },
  {
    title: 'Indie Pulse',
    subtitle: 'Guitarras, synths y energia',
    description: 'Canciones que se sienten recien descubiertas.',
    accent: 'forest',
    mood: 'Chill'
  },
  {
    title: 'House Select',
    subtitle: 'Grooves para seguir moviendo',
    description: 'Cuatro por cuatro, voces cortadas y bajos elasticos.',
    accent: 'neon',
    mood: 'Workout'
  }
];
